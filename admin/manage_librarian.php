...
<script>
  ...
  if(!(localStorage['login']=="success")){
    ...
    <title> Manage Librarian | LIBRARY</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container">
              ...
              <center><h2>Manage Librarian</h2></center>
               <div class="row">
               
                 <hr>
                <div class="col-md-11" >
                      <form action="manage_librarian.php" method="post"> 
                ...
                if(isset($_POST['add_user'])){
                    ...
                    $password = "XYZ123";
                    $save = "INSERT INTO `librarian` (`email`, `password`, `name`) VALUES ('$email', '$password', '$name');";
                    ...
                    if($save){
                        ...
                        <script type="text/javascript">
                            alert("Librarian Was added Successfully");
                        </script>
                        <?php
                    }else{
                        ?>
